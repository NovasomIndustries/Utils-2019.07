CYPRESS_BSA_SITE = $(TOPDIR)/../../Utils/rock/external/bluetooth_bsa
...
define CYPRESS_BSA_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 644 $(TOPDIR)/../../Utils/rock/external/bluetooth_bsa/test_files/av/8k8bpsMono.wav $(TARGET_DIR)/etc/bsa_file/
	$(INSTALL) -D -m 644 $(TOPDIR)/../../Utils/rock/external/bluetooth_bsa/test_files/av/8k16bpsStereo.wav $(TARGET_DIR)/etc/bsa_file/
