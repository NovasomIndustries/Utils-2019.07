...
define APACHE_CLEANUP_TARGET
	...
	mkdir -p $(TARGET_DIR)/tmp/www/html
	cp package/apache/httpd.conf $(TARGET_DIR)/etc/apache2/httpd.conf
	mkdir -p $(TARGET_DIR)/etc/init.d
	cp package/apache/S99apache2 $(TARGET_DIR)/etc/init.d/S99apache2
	chmod 777 $(TARGET_DIR)/etc/init.d/S99apache2
endef
